...
export function SubscriptionsView({
  ...
  const displaySubs     = subscriptions as unknown as DriverSubscription[]
  const displaySubTotal = subsTotal
  const displayPayments = payments as unknown as SubscriptionPayment[]
  const displayPayTotal = paymentsTotal
